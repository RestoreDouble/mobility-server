...
func (cc *CustomerCreate) SetNillableDateOfBirth(t *time.Time) *CustomerCreate {
	if t != nil {
		cc.SetDateOfBirth(*t)
	}
	return cc
...
func (cc *CustomerCreate) SetIsNew(b bool) *CustomerCreate {
	cc.mutation.SetIsNew(b)
	return cc
}

// SetNillableIsNew sets the "is_new" field if the given value is not nil.
func (cc *CustomerCreate) SetNillableIsNew(b *bool) *CustomerCreate {
	if b != nil {
		cc.SetIsNew(*b)
	}
	return cc
...
func (cc *CustomerCreate) defaults() {
	...
	if _, ok := cc.mutation.IsNew(); !ok {
		v := customer.DefaultIsNew
		cc.mutation.SetIsNew(v)
	}
...
func (cc *CustomerCreate) check() error {
	...
	if _, ok := cc.mutation.IsNew(); !ok {
		return &ValidationError{Name: "is_new", err: errors.New(`ent: missing required field "Customer.is_new"`)}
	}
	return nil
}
...
func (cc *CustomerCreate) createSpec() (*Customer, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.IsNew(); ok {
